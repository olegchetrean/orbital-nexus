...
const DICT = {
  ...
  viewSky: { ro: 'Cer', en: 'Sky' },
  viewGlobeTitle: { ro: 'Glob 3D', en: '3D globe' },
  viewMapTitle: { ro: 'Hartă plată', en: 'Flat map' },
  viewSkyTitle: { ro: 'Cerul de deasupra ta', en: 'The sky above you' },

  /* --- modul Cer --- */
  skyDay: { ro: 'e zi', en: 'daylight' },
  skyTwilight: { ro: 'crepuscul', en: 'twilight' },
  skyDark: { ro: 'cer întunecat', en: 'dark sky' },
  skySunEl: { ro: 'Soarele {deg}°', en: 'Sun {deg}°' },
  skyAbove: { ro: '{n} deasupra orizontului', en: '{n} above the horizon' },
  skyEye: { ro: '{n} vizibile cu ochiul liber', en: '{n} visible to the naked eye' },
  skyMoon: { ro: 'Luna', en: 'Moon' },
  skyLegendEye: { ro: 'se vede cu ochiul liber', en: 'visible to the naked eye' },
  skyLegendDim: { ro: 'deasupra ta, dar prea slab', en: 'above you, but too faint' },
  skyNeedLocation: { ro: 'De unde privești?', en: 'Where are you looking from?' },
  skyNeedLocationHint: {
    ro: 'Cerul se calculează pentru locul tău. Poți și să dai click pe hartă, în modul Observator.',
    en: 'The sky is computed for your spot. You can also click the map in Observer mode.',
  },
  skyEnableCompass: { ro: '🧭 Pornește busola', en: '🧭 Enable the compass' },
  skyUseGyro: { ro: '🧭 Ridică telefonul', en: '🧭 Raise the phone' },
  skyManualLook: { ro: '✋ Privire cu degetul', en: '✋ Look by dragging' },
  skyCalibrate: { ro: '⚙ Reglaj', en: '⚙ Adjust' },
  skyExit: { ro: '✕ Ieși', en: '✕ Exit' },
  skyOnScreen: { ro: 'e în cadru — uită-te acolo', en: 'in frame — look there' },
  skyBelowHorizon: {
    ro: 'e sub orizont acum · vezi când răsare, la Treceri',
    en: 'below the horizon right now · see Passes for the next rise',
  },
  skyTurnRight: { ro: 'rotește-te la dreapta {deg}°', en: 'turn right {deg}°' },
  skyTurnLeft: { ro: 'rotește-te la stânga {deg}°', en: 'turn left {deg}°' },
  skyRaise: { ro: 'ridică telefonul {deg}°', en: 'raise the phone {deg}°' },
  skyLower: { ro: 'coboară telefonul {deg}°', en: 'lower the phone {deg}°' },
  skyCalibTitle: { ro: 'Reglaj busolă și cadru', en: 'Compass and framing' },
  skyCalibHint: {
    ro: 'Dacă stelele de pe ecran nu cad peste cele de pe cer, mută cursorul până se suprapun.',
    en: 'If the stars on screen do not line up with the real ones, slide until they do.',
  },
  skyCompassRelative: {
    ro: 'Telefonul nu raportează nordul absolut. Îndreaptă-te spre o stea pe care o recunoști și potrivește cursorul.',
    en: 'This phone does not report true north. Point at a star you recognise and match it with the slider.',
  },
  skyFov: { ro: 'Cadru', en: 'Field' },
  skySourceLabel: { ro: 'Sursa orientării', en: 'Orientation source' },
  skySource_absolute: { ro: 'busolă absolută', en: 'absolute compass' },
  skySource_compass: { ro: 'busola iOS', en: 'iOS compass' },
  skySource_relative: { ro: 'giroscop fără nord', en: 'gyroscope without north' },
  skySource_none: { ro: 'manual', en: 'manual' },
  skyFindInSky: { ro: '🧭 Găsește-l pe cer', en: '🧭 Find it in the sky' },
  elevation: { ro: 'elevație', en: 'elevation' },
  azimuth: { ro: 'azimut', en: 'azimuth' },
